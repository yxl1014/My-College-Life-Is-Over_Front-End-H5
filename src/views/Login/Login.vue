<template>
  <div class="back">
    <div class="mainBox">
      <img class="leftImg" src="@/assets/img/OIF.jpeg">

      <div class="loginBox">
        <div style="width: 80%; text-align: center; word-wrap: break-word;">
          欢迎登陆&nbsp;LoadRunnerX&nbsp;压力测试平台
        </div>
      ...
      " class='sizeAndSpacing'>
            ...
            <el-link type="primary" class="sizeAndSpacing">没有账号，免费注册>></el-link>
          </el-tab-pane>
          <el-tab-pane label="短信登录"></el-tab-pane>
