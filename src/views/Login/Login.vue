<template>
  ...
  <div style="width: 200px;display:flex;align-items: center;justify-content:space-around;">
    <el-input v-model="form.code" placeholder="请输入验证码" clearable style="width: 100px;"/>
    <el-image :lazy="true" style="width: 80px; height: 30px" :src="CodeImg" fit="fill" />
  </div>
